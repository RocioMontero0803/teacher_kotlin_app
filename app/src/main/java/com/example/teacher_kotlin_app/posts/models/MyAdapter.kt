package com.example.teacher_kotlin_app.posts.models
...
import com.example.teacher_kotlin_app.posts.DetailActivity
...
class MyAdapter (private val context: Context, private var dataList: List<DataClass>) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.post_recycle, parent, false)
